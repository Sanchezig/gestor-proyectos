...
<td class="dash-num-center">${fte.toLocaleString('es-ES', { minimumFractionDigits: 1 })}</td>
    ...
    teamMembers.forEach(user => {
        ...
        html += `
                    <tr>
                        ...
                        <td class="cap-percent ${colorClass1}">${percent1}%</td>
                        <td class="cap-percent ${colorClass2}">${percent2}%</td>
                    </tr>`;
    });
    ...
    // Event listeners
    setTimeout(() => {
        document.getElementById('dashFilterProyecto').addEventListener('input', (e) => {
